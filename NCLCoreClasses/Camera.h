...
public:
    ...
    virtual void UpdateAngleByAxis(float dt);

    virtual void UpdatePositionByKey(float dt);
    ...
    virtual Matrix4 BuildViewMatrix() const;
    ...
    Camera &SetPosition(const Vector3 &val) {
        position = val;
        return *this;
    }
